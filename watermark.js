...
const innerLoadMark = function (settings = {}) {
  ...
  if (setting.watermark_parent_width || setting.watermark_parent_height) {
    if (setting.watermark_parent_width) {
      page_width =
        setting.watermark_parent_width - defaultSettings.watermark_width / 2;
    } else {
    ...
    if (setting.watermark_parent_height) {
      page_height =
        setting.watermark_parent_height - defaultSettings.watermark_height / 2;
    } else {
      if (defaultSettings.watermark_parent_node) {
        page_height =
    ...
    if (parentEle) {
      ...
      page_offsetLeft = parentEle.offsetLeft || 0;
      page_width =
        parentEle.offsetWidth - defaultSettings.watermark_width / 2 || 0;
      page_height =
        Math.max(parentEle.offsetHeight, parentEle.scrollHeight) -
